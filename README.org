...
*NOTE*:
As I have completely redeveloped [[https://github.com/ginqi7/e-spotlight][e-spotlight]], this project has been archived. Given the fundamental changes in its principles, we will be launching a new project.
